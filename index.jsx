  ...
  const saveResults = async (sortedGifts) => {
    try {
      ...
      await window.storage.set(
        `assessment:${timestamp}:${name.replace(/\s+/g, '_')}`,
        JSON.stringify(resultData),
        true // shared so you can access all results
      );
    } catch (error) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <p>
              Your results have been saved and are accessible to the assessment administrator.
            </p>
          </div>
        </div>
      </div>
